                ...
                <div class="col-sm-3" id="box-vertical-megamenus">
                    ...
                    <div class="vertical-menu-content is-home">
                        <ul class="vertical-menu-list">
                            <li><a href="<?php echo 'men.php?id=5';?>"><img class="icon-menu" alt="Funky roots" src="html/assets/data/1.png">Mens Fashions</a></li>
                            
                            <li><a href="<?php echo 'women.php?id=8';?>"><img class="icon-menu" alt="Funky roots" src="html/assets/data/3.png">Womens Fashions</a></li>
                            <li><a href="<?php echo 'kids.php?id=44';?>"><img class="icon-menu" alt="Funky roots" src="html/assets/data/4.png">Kids Fashions</a></li>
                            ...
                            <div class="layered-content">
                                <ul class="tree-menu">
								 ...
								 while($cat1_ro = mysql_fetch_assoc($cat1_r)){
									 ?>
									 <li><span></span><a href="javascript:;" onClick="category('<?php echo $cat1_ro['cat_name'];?>','<?php echo $cat1_ro['person'];?>')"><?php echo $cat1_ro['cat_name'];?></a></li>
									 <?php
                                     }
									 ?>
                            ...
                            <div class="layered-content">
                                <ul class="tree-menu">
								 ...
								 while($cat5_ro = mysql_fetch_assoc($cat5_r)){
									 ?>
									 <li><span></span><a href="home_and_living.php"><?php echo $cat5_ro['cat_name'];?></a></li>
									 <?php
                                     }
									 ?>
                                </ul>
                    ...
                    <ul class="nav-tab">
                        ...
                        <?php
								 ...
								 $cat = $tab_fetchi['cat_name'];
									 ?>
                            <a data-toggle="tab" href="javascript:;"><?php echo 'Women fashion';?></a>
                        </li>
                ...
                <div id="view-product-list" class="view-product-list">
                   ...
                   <div class="tab-container">
                    ...
                    <?php
								 ...
								 $tab = mysql_query("SELECT * FROM items WHERE category='".$cat."' AND person='women' ")or die(mysql_error());
  ...
  <div class="modal fade" id="my_mode" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"> 
         <div class="modal-dialog"> 
          <div class="modal-content"> 
           <div class="modal-header"> 
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"> &times; </button> 
            <h4 class="modal-title" id="myModalLabel"> Women's Page</h4> 
           </div> 
