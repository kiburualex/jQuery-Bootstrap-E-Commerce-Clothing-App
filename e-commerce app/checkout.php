...
<!-- Mirrored from kutethemes.com/html/kuteshop/html/checkout.html by HTTrack Website Copier/3.x [XR&CO'2013], Sun, 27 Sep 2015 11:10:49 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <title>Checkout - Suzzie Shop</title>
    <script>
	...
	function place_order(){
	  	...
	  	$.post('functions.php',{task:"place_order",fname:fname,lname:lname,email:email,phone:phone,location:location},function(data){
			...
			$('.modal-body').html(data);
					...
					$('#myModal').on('hide.bs.modal', function () { 
					      if(data== 'Order Placed Successfully'){
			                $.post('functions.php',{task:"empty"},function(){
							 //do something
...
<body class="category-page" onLoad="check_view_cart()">
<!-- HEADER -->
...
<div class="columns-container">
    <div class="container" id="columns">
        ...
        <div class="page-content checkout-page">
            ...
            <h3 class="checkout-sep">1. Checkout Details</h3>
                ...
                <ul>
                    ...
                    <li class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="input form-control" type="text" name="fname" id="fname">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="input form-control" type="text" name="lname" id="lname">
                    ...
                    <li class="row">
                        ...
                        <div class="col-xs-12">
                            ...
                            <label for="location" class="required">Address</label>
