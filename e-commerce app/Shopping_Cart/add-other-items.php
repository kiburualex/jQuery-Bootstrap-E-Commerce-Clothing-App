...
<div class="row aside_row">
   ...
   <div class="row" style="text-align:center;padding-top:15px;">
     ...
     <a data-toggle="collapse" data-parent="#accordion" href="#collapseFour">
         ...
         <li><a href="add-other-items.php" class="active">Add Items</a></li>
   ...
   <section class="main-content col-md-9" id="main-content">
       <div class="content">
            <div class="row" id="row1">
             ...
             <h1 style="font-size:1.4em;">Add items to the Other's panel</h1>
       </div>
           ...
           <div class="panel col-md-10">
              ...
              <form role="form" action="process-add-item.php" method="post" enctype="multipart/form-data">
                 ...
                 <!--============THE IMAGE FORM GROUP===============-->
                   ...
                   <input type="hidden" name="url" value="add-other-items.php"/> 
                  <input type="hidden" name="url2" value="view-other-items.php"/> 
