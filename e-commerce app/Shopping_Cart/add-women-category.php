     ...
     <div class="panel" id="panel" style="border:none;border-radius:0px;"> 
         <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">
          ...
          <div id="collapseTwo" class="panel-collapse collapse in"> 
           <div class="panel-body" id="panel-body"> <ul class="nav men-nav">
         <li><a href="add-women-category.php" class="active">Add Category</a></li>
   ...
   <section class="main-content col-md-9" id="main-content">
       <div class="content">
            <div class="row" id="row1">
             ...
             <h1 style="font-size:1.4em;">Add category to the women's panel</h1>
       </div>
       <div class="row" style="margin:0 auto;">
           <div class="panel col-md-9">
              <div class="panel-body">
              <form role="form" action="process_cat.php" method="post">
                 <div class="form-group"> 
                  <label for="name">Name</label> 
                  <input type="text" class="form-control" id="category" name="category" placeholder="Enter Category Name"> 
                  <input type="hidden" name="person" value="women"/> 
                  <input type="hidden" name="url" value="add-women-category.php"/>
                  <input type="hidden" name="url2" value="view-women-category.php"/>
                 </div>
