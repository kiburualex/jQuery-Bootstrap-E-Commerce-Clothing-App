   ...
   <section class="main-content col-md-9" id="main-content">
       <div class="content">
            <div class="row" id="row1">
             ...
             <h1 style="font-size:1.4em;">Edit Categories</h1>
       </div>   
       <div class="row" style="margin:0 auto;">
           <div class="panel col-md-9">
            
              <div class="panel-body">
              <form role="form" id="add_men_cat" action="process_edit_cat.php" method="post">
                 <div class="form-group"> 
                  ...
                  echo '<input type="text" class="form-control" id="cat" name="cat" value="'.$row['cat_name'].'"> ';
                 echo '</div>';
				 echo '<input type="hidden" value = "'.$row['id'].'" name="id"/>';
                 echo '<button type="submit" class="btn btn-primary" id="btn-primary1">Update</button>';
