...
<div class="row aside_row">
   ...
   <div class="row" style="text-align:center;padding-top:15px;">
     ...
     <div class="panel" id="panel" style="border:none;border-radius:0px;"> 
         ...
         <li><a href="view-women-category.php" class="active">View Categories</a></li>
   ...
   <section class="main-content col-md-9" id="main-content">
       <div class="content">
            <div class="row" id="row1">
             <img src="image/icons/women_icon.png" width="100" height="100"/>
             <h1 style="font-size:1.4em;">View categories in the women's panel</h1>
       </div>
       <div class="row" style="margin:0 auto;">
           <div class="panel col-md-9">
              ...
              <?php
					...
					$result = mysql_query('SELECT * FROM categories WHERE person = "women"');
					
					$view = "view-women-category.php";
                ...
                echo '
                   <tr> 
                    <td>'.$row['cat_name'].'</td> 
                    <td><a href="edit-cat.php?id='.$row['id'].'" style="text-decoration:none;">Edit</a></td>
                    <td><a href="delete_category.php?id='.$row['id'].'&t=categories&u='.$view.'" style="text-decoration:none;">Delete</a></td> 
                    </tr> ';
					} 
                  echo '</tbody> 
                </table>';
