...
<div class="row aside_row">
   ...
   <div class="row" style="text-align:center;padding-top:15px;">
     ...
     <a data-toggle="collapse" data-parent="#accordion" href="#collapseFive">
         ...
         <li><a href="view-home-category.php" class="active">View Categories</a></li>
   ...
   <section class="main-content col-md-9" id="main-content">
       <div class="content">
            <div class="row" id="row1">
             ...
             <h1 style="font-size:1.4em;">View categories in the Other's panel</h1>
       </div>
       <div class="row" style="margin:0 auto;">
           <div class="panel col-md-9">
              ...
              <?php
					...
					$result = mysql_query('SELECT * FROM categories WHERE person = "home"');
					
					$view = "view-home-category.php";
