   ...
   <section class="main-content col-md-9"  id="main-content">
       <div class="content">
            <div class="row" id="row1">
             ...
             <h1 style="font-size:1.4em;">Update the particular category</h1>
       </div>
           ...
           <div class="panel col-md-9">
              ...
              <?php
					...
					if(isset($cat)&& !empty($cat)){
					    ...
					    $query = "UPDATE categories SET cat_name ='".$cat."' WHERE id ='".$id."'";
					    $result = mysql_query($query);
						
						$result2 = mysql_query("SELECT * FROM categories WHERE id=".$id);
						...
						if($result == true){
                               ...
                               echo '<a href="view-'.$row['person'].'-category.php" class="btn btn-primary pull-right" style="text-decoration:none;border-radius:0px;">View the Category list.</a>';
							   }
							   
							}else{echo '<img src="image/icons/_0005_Delete.png" width="40" height="40"/> Failed';}
					}else{
						...
						echo '<a href="edit-cat.php?id='.$id.'" class="btn btn-warning pull-right" style="text-decoration:none;border-radius:0px;">Go back</a>';
					 } 
