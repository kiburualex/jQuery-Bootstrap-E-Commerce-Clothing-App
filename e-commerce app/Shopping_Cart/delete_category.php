   ...
   <section class="main-content col-md-9" id="main-content">
       <div class="content">
            <div class="row" id="row1">
             ...
             <h1 style="font-size:1.4em;"><img src="image/icons/_0005_Delete.png" width="40" height="40"/> Are you sure you want to Delete it?</h1>
       </div>
       <div class="row" style="margin:0 auto;">
           <div class="panel col-md-6">
            <div class="panel-heading">
              <div class="panel-body">
              <form role="form" id="add_men_cat" action="#" method="post" style="text-align:center;">
                 ...
                 <?php 
					...
					$u = $_GET['u'];
				 ?>
                 <a href="<?php echo $u;?>" class="btn btn-primary btn-lg pull-left" style="border-radius:0px;">No</a>
                 <a href="delete.php?id=<?php echo $id;?>&t=<?php echo $table;?>&u=<?php echo $u;?>" class="btn btn-lg btn-primary pull-right" style="border-radius:0px;">Yes</a></div>
