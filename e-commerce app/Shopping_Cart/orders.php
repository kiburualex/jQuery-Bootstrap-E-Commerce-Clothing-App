	...
	function fullfilled(a){
		...
		/*var id = a;
		  $.ajax({
			 url: 'order_functions.php',
			 type:'post',
			 data:{task:"Fullfilled_update",id:id},
			 success: function(){
				$("#"+id).fadeOut();
			    }
			});*/
     ...
     <a data-toggle="collapse" data-parent="#accordion" href="#collapseFive">
      ...
      <a data-toggle="collapse" data-parent="#accordion" href="#collapseSix">
          ...
          <div id="collapseSix" class="panel-collapse collapse in"> 
           <div class="panel-body" id="panel-body"> <ul class="nav men-nav">
         <li><a href="orders.php" class="active">View Orders</a></li>
   ...
   <section class="main-content col-md-9" id="main-content">
       <div class="content">
            <div class="row" id="row1">
             ...
             <h1 style="font-size:1.4em;">View the Order's panel</h1>
       </div>
       <div class="row" style="margin:0 auto;">
           <div class="panel">
              ...
              <?php
					...
					$result = mysql_query('SELECT * FROM orders WHERE state="Not Fullfilled"');
                   ...
                   <tr id="'.$row['order_id'].'"> 
					...
					<td>
					 <select style="padding:8px;" class="sel">
					   <option selected="selected" value="Not Fullfilled">Not Fullfilled</option>
...
$(function () { 
   ...
   $('.sel').on('change', function() {
       var value = $(this).val();
		...
		if(value == 'Fullfilled'){
		   	$.post('order_functions.php', {task:"Fullfilled_update",id:id}, function(){
