...
<div class="row aside_row">
   ...
   <div class="row" style="text-align:center;padding-top:15px;">
     ...
     <div class="panel" id="panel" style="border:none;border-radius:0px;"> 
         ...
         <li><a href="add-women-items.php" class="active">Add Items</a></li>
   ...
   <section class="main-content col-md-9" id="main-content">
       <div class="content">
            <div class="row" id="row1">
             ...
             <h1 style="font-size:1.4em;">Add items to the women's panel</h1>
           ...
           <div class="panel col-md-10">
              ...
              <form role="form" action="process-add-item.php" method="post" enctype="multipart/form-data">
                 ...
                 <!--============THE IMAGE FORM GROUP===============-->
                   ...
                   <input type="hidden" name="url" value="add-women-items.php"/> 
                  <input type="hidden" name="url2" value="view-women-items.php"/> 
