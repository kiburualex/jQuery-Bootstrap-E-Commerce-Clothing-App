   ...
   <section class="main-content col-md-9" id="main-content">
       <div class="content">
            <div class="row" id="row1">
             ...
             <h1 style="font-size:1.4em;">Add categories to the Other's panel</h1>
       </div>
           ...
           <div class="panel col-md-9">
              ...
              <form role="form" action="process_cat.php" method="post">
                 <div class="form-group"> 
                  ...
                  <input type="hidden" name="person" value="other"/> 
                  <input type="hidden" name="url" value="add-other-category.php"/> 
                  <input type="hidden" name="url2" value="view-other-category.php"/>
                 </div>
