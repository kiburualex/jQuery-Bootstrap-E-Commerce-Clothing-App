...
<div class="row aside_row">
   ...
   <div class="row" style="text-align:center;padding-top:15px;">
     ...
     <div class="panel" id="panel" style="border:none;border-radius:0px;"> 
         ...
         <li><a href="view-women-items.php" class="active">View Items</a></li>
         </ul> </div> 
          </div> 
     </div> 
   ...
   <section class="main-content col-md-9" id="main-content">
       <div class="content">
            <div class="row" id="row1">
             ...
             <h1 style="font-size:1.4em;">View items in the women's panel</h1>
       </div>
           ...
           <div class="panel col-md-12">
              ...
              <div class="table-responsive" style="padding:10px;">
               <?php
					...
					$result = mysql_query('SELECT * FROM items WHERE person = "women"');
