   ...
   <section class="main-content col-md-9" id="main-content">
       <div class="content">
            <div class="row" id="row1">
             ...
             <h1 style="font-size:1.4em;">Delete details.</h1>
       </div>
           ...
           <div class="panel col-md-9">
              ...
              <?php
					...
					$u = $_GET['u'];
						...
						if($result == true){
							   echo '<img src="image/icons/_0007_Tick.png" width="40" height="40"/> <i class="text-success" style="font-size:1.2em;">Successfully Deleted</i>';
							   echo '<a href="'.$u.'" class="btn btn-primary pull-right" style="text-decoration:none;border-radius:0px;">View the '.$table.' list.</a>';
							}else{echo '<i class="text-danger">Failed to Delete<i>';}
