   ...
   <div class="row" style="text-align:center;padding-top:15px;">
     ...
     <a data-toggle="collapse" data-parent="#accordion" href="#collapseFive">
          ...
          <div id="collapseFive" class="panel-collapse collapse in"> 
           <div class="panel-body" id="panel-body"> <ul class="nav men-nav">
         <li><a href="add-home-category.php" class="active">Add Category</a></li>
           ...
           <div class="panel col-md-9">
              ...
              <form role="form" action="process_cat.php" method="post">
                 <div class="form-group"> 
                  ...
                  <input type="hidden" name="person" value="home"/> 
                  <input type="hidden" name="url" value="add-home-category.php"/> 
                  <input type="hidden" name="url2" value="view-home-category.php"/>
                 </div>
