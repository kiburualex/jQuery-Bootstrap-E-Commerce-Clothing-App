   ...
   <aside class="sidebar col-md-3">
     ...
     <div class="panel-group" id="accordion" style="padding-top:30px;">
       ...
       <div class="panel panel-nav" id="panel" style="border:none;border-radius:0px;">
         ...
         <li><a href="add-men-category.php" class="active">Add Category</a></li>
   ...
   <section class="main-content col-md-9" id="main-content">
       <div class="content">
            <div class="row" id="row1">
             ...
             <h1 style="font-size:1.4em;">Add categories to the men's panel</h1>
            </div>
       <div class="row" style="margin:0 auto;">
           <div class="panel col-md-9">
            <div class="panel-heading">
           
                <div class="feeback" style="color:#246DF4;"></div>
            </div>
              <div class="panel-body">
              <form role="form" id="add_men_cat" action="process_cat.php" method="post">
                 <div class="form-group"> 
                  <label for="men_cat">Name</label> 
                  ...
                  <input type="hidden" name="url" value="add-men-category.php"/>
                  <input type="hidden" name="url2" value="view-men-category.php"/>
                 </div>
