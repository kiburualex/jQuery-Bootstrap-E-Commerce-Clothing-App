   ...
   <div class="row" style="text-align:center;padding-top:15px;">
     ...
     <a data-toggle="collapse" data-parent="#accordion" href="#collapseFour">
          ...
          <div id="collapseFour" class="panel-collapse collapse"> 
           <div class="panel-body" id="panel-body"> <ul class="nav men-nav">
         <li><a href="add-other-category.php" class="active">Add Category</a></li>
   ...
   <section class="main-content col-md-9" id="main-content">
       <div class="content">
            <div class="row" id="row1">
             ...
             <h1 style="font-size:1.4em;">Category submission details</h1>
       </div>
           ...
           <div class="panel col-md-9">
              ...
              <?php
					...
					if(isset($category)&& !empty($category)){
					    ...
					    $query = "INSERT INTO categories (id, cat_name, person) VALUES ('".$id."', '".$category."', '".$person."')";
						...
						if($result == true){
							   ...
							   echo '<a href="'.$url2.'" class="btn btn-primary pull-right" style="text-decoration:none;border-radius:0px;">View the Category list.</a>';
