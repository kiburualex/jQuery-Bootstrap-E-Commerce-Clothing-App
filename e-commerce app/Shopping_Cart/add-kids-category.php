   ...
   <div class="row" style="text-align:center;padding-top:15px;">
     ...
     <a data-toggle="collapse" data-parent="#accordion" href="#collapseThree">
          ...
          <div id="collapseThree" class="panel-collapse collapse in"> 
           <div class="panel-body" id="panel-body"> <ul class="nav men-nav">
         <li><a href="add-kids-category.php" class="active">Add Category</a></li>
   ...
   <section class="main-content col-md-9" id="main-content">
       <div class="content">
            <div class="row" id="row1">
             ...
             <h1 style="font-size:1.4em;">Add categories to the kid's panel</h1>
       </div>
           ...
           <div class="panel col-md-9">
              ...
              <form role="form" action="process_cat.php" method="post">
                 <div class="form-group"> 
                  ...
                  <input type="hidden" name="person" value="kids"/> 
                  <input type="hidden" name="url" value="add-kids-category.php"/> 
                  <input type="hidden" name="url2" value="view-kids-category.php"/>
                 </div>
