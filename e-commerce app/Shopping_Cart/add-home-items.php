...
<div class="row aside_row">
   ...
   <div class="row" style="text-align:center;padding-top:15px;">
     ...
     <a data-toggle="collapse" data-parent="#accordion" href="#collapseFive">
         ...
         <li><a href="add-home-items.php" class="active">Add Items</a></li>
           ...
           <div class="panel col-md-10">
              ...
              <form role="form" action="process-add-item.php" method="post" enctype="multipart/form-data">
                 ...
                 <!--============THE IMAGE FORM GROUP===============-->
                   ...
                   <input type="hidden" name="url" value="add-home-items.php"/> 
                  <input type="hidden" name="url2" value="view-home-items.php"/> 
