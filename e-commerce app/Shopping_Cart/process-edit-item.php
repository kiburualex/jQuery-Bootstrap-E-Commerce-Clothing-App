   ...
   <section class="main-content col-md-9" id="main-content">
       <div class="content">
            <div class="row" id="row1">
             ...
             <h1 style="font-size:1.4em;">Edit Item</h1>
       </div>
       <div class="row" style="margin:0 auto;">
           <div class="panel col-md-8">
              ...
              <?php
					...
					if((isset($id) && !empty($id)) && (isset($name)&& !empty($name)) && (isset($category)&& !empty($category)) && (isset($new)&& !empty($new)) && (isset($price)&& !empty($price)) && (isset($description)&& !empty($description))){
						...
						$query = "UPDATE items SET name ='".$name."', category ='".$category."', new ='".$new."', price ='".$price."', description ='".$description."', image_location ='".$image_location."' WHERE id ='".$id."'";
							}else{
								$query = "UPDATE items SET name ='".$name."', category ='".$category."', new ='".$new."', price ='".$price."', description ='".$description."' WHERE id ='".$id."'";
								}
						...
						if($result == true){
							   echo '<img src="image/icons/_0007_Tick.png" width="40" height="40"/> <i class="text-success" style="font-size:1.2em;">Successfully Updated</i>';
							   echo '<a href="view-'.$person.'-items.php" class="btn btn-primary pull-right" style="text-decoration:none;border-radius:0px;">View the items list.</a>';
							}else{echo '<img src="image/icons/_0005_Delete.png" width="40" height="40"/> <i class="text-danger" style="font-size:1.2em;">Failed to Update</i>';
							      echo '<a href="edit-'.$person.'-item.php?id='.$id.'" class="btn btn-primary pull-right" style="text-decoration:none;border-radius:0px;">Go back</a>';
							}
					}else{
						...
						echo '<a href="edit-item.php?id='.$id.'" class="btn btn-warning pull-right" style="text-decoration:none;border-radius:0px;">Go back</a>';
					 } 
