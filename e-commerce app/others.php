                            ...
                            <div class="layered-content">
                                <ul class="tree-menu">
								 ...
								 while($cat4_ro = mysql_fetch_assoc($cat4_r)){
									 ?>
									 <li><span></span><a href="javascript:;" onClick="category('<?php echo $cat4_ro['cat_name'];?>','<?php echo $cat4_ro['person'];?>')"><?php echo $cat4_ro['cat_name'];?></a></li>
									 <?php
                                     }
									 ?>
                                </ul>
                ...
                <div class="subcategories">
                    <ul class="nav-tab">
                        ...
                        <?php
								 ...
								 $tabi = mysql_query("SELECT * FROM categories WHERE person='other' ")or die(mysql_error());
								 $tab_fetchi = mysql_fetch_assoc($tabi);
								 $pers = $tab_fetchi['person'];
								 $cat = $tab_fetchi['cat_name'];
									 ?>
                            <a data-toggle="tab" href="javascript:;"><?php echo 'other accessories';?></a>
                        </li>
  ...
  <div class="modal fade" id="my_mode" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"> 
         <div class="modal-dialog"> 
          <div class="modal-content"> 
           <div class="modal-header"> 
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"> &times; </button> 
            <h4 class="modal-title" id="myModalLabel"> Others Page</h4> 
           </div> 
