                            ...
                            <div class="layered-content">
                                <ul class="tree-menu">
								 ...
								 while($cat3_ro = mysql_fetch_assoc($cat3_r)){
									 ?>
									 <li><span></span><a href="javascript:;" onClick="category('<?php echo $cat3_ro['cat_name'];?>','<?php echo $cat3_ro['person'];?>')"><?php echo $cat3_ro['cat_name'];?></a></li>
									 <?php
                                     }
									 ?>
                                </ul>
                    ...
                    <ul class="nav-tab">
                        ...
                        <?php
								 ...
								 $cat = $tab_fetchi['cat_name'];
									 ?>
                            <a data-toggle="tab" href="javascript:;"><?php echo 'kids fashion';?></a>
                        </li>
                ...
                <div id="view-product-list" class="view-product-list">
                   ...
                   <div class="tab-container">
                    ...
                    <?php
								 ...
								 $tab = mysql_query("SELECT * FROM items WHERE category='".$cat."' AND person='kids' ")or die(mysql_error());
  ...
  <div class="modal fade" id="my_mode" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"> 
         <div class="modal-dialog"> 
          <div class="modal-content"> 
           <div class="modal-header"> 
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"> &times; </button> 
            <h4 class="modal-title" id="myModalLabel"> Kid's Page</h4> 
           </div> 
